...
router.get("/overview", (req, res) => {
  try {
    ...
    const overview = {
      ...
      tokenomics: {
        LumerisPrice: marketData.LumerisPrice,
        LumerisMarketCap: marketData.LumerisMarketCap,
        LumerisCirculatingSupply: marketData.LumerisCirculatingSupply,
        LumerisTotalSupply: marketData.LumerisTotalSupply,
        priceChange24h: 5.2,
        priceChange7d: 12.8,
        priceChange30d: -3.5,
      },
...
router.get("/market-data", (req, res) => {
  try {
    ...
    const realTimeData = {
      timestamp: new Date().toISOString(),
      Lumeris: {
        price: marketData.LumerisPrice + (Math.random() - 0.5) * 0.1,
        change24h: 5.2,
        volume24h: 2500000,
        marketCap: marketData.LumerisMarketCap,
        circulatingSupply: marketData.LumerisCirculatingSupply,
      },
      topTokens: [
        { symbol: "Lumeris", price: 0.85, change24h: 5.2, volume: 2500000 },
      ...
      trending: [
        { symbol: "Lumeris", volume: 2500000, change: 5.2 },
